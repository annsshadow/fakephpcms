                            ...
                            <div class="box-header margin margin-bottom-none">
                                <div class="col-md-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="headline" class="form-control" placeholder="文章标题（20字以内）">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-6 form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="author" class="form-control" value="计算机科学与技术学院" >
                                    </div>
                                </div>
                                <div class="col-md-1 col-sm-6 form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">排序</span>
                                        <input type="number" name="order" class="form-control" value="0" placeholder="默认是0，可不修改">
                                    </div>
                                </div>
                                <div class="col-md-2 col-sm-6 form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">置顶</span>
                                        <input type="number" name="top" class="form-control" value="0" placeholder="置顶请修改为1,审核后才能置顶">
                                    </div>
                                </div>
                                <div class="col-md-2 col-sm-6 form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon">时间</span>
                                        <input type="text" name="time" class="form-control" placeholder="选择时间" id="reservation">
                                    </div>
                                </div>
                            </div>
                            <div class="box-body">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group margin pull-right">
                                        <input type="submit" name="submit" id="submitBtn" value="提交" class="btn btn-primary"></input>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
