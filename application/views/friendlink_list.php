...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<a href="<?php echo $base_url;?>bluescms/friendlink/friendlink_add/">添加友情链接</a>
	</div>
	<br />
	<div>
		<ul>
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">网址</span>
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">操作</span>
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">操作</span>
    <br />
			<?php if ($result): ?>
				<?php foreach ($result as $key => $value): ?>
					<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href="<?php echo $value['url']?>"><?php echo $value['headline']?></a>
