...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <form method="post" id="form1" action="<?php echo $base_url;?>bluescms/index.php/user_article/user_article_add_post/">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group margin pull-right">
                                        <input type="submit" name="submit" id="submitBtn" value="提交" class="btn btn-primary">
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
