                                ...
                                <?php if(is_array($result)): ?>
                                    <?php foreach ($result as $key => $value): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $value['top']?'已通过':'未通过';?></td>
                                            <td>
                                                <div class="btn-group btn-group-xs">
                                                    <?php if($value['top']):?>
                                                    <a href="<?php echo $value['url_cancel'];?>" class="btn btn-default">取消通过</a>
                                                    <?php else:?>
                                                        <a href="<?php echo $value['url_check'];?>" class="btn btn-default">审核通过</a>
                                                    <?php endif; ?>
