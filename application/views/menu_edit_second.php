...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <form method="post" action="<?php echo $base_url;?>bluescms/index.php/menu/menu_edit_post/">
                                ...
                                <div class="margin">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="menu_order" value="<?php echo $menu_order;?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>所属一级栏目</strong></span>
                                            <select class="form-control" name="menu_id_first">
