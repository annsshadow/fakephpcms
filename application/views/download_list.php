...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<a href="<?php echo $base_url;?>bluescms/index.php/download/download_add/">添加下载内容</a>
	</div>
	<br />
	<div>
		<ul>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">所属栏目</span>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">添加日期</span>
      <span style = "width:350px; height:20px; overflow:hidden; display:inline-block;">标题</span>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">上传者</span>
      ...
      <br />
          ...
          <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['createtime'];?></span>
					<a style="width:350px; height:20px; overflow:hidden;display:inline-block;" href="<?php echo $value['url_download']?>"><?php echo $value['headline']?></a>
          <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['author'];?></span>
					<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href="<?php echo $value['url_delete']?>">删除</a><br />
				<?php endforeach;?>
