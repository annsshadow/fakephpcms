...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-sm-8">
                    <form method="post" action="<?php echo $base_url . 'bluescms/index.php/ad/ad_edit_post/';?>">
                                ...
                                <div class="margin">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="ad_headline" value=<?php echo $result['ad_headline'];?>>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>链接</strong></span>
                                            <input type="text" class="form-control" name="ad_url" value="<?php echo $result['ad_url'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <div id ="ueditor">
                                                <!-- 加载编辑器的容器 -->
                                                <script id="container" name="ad_img" type="text/plain">
                                                <?php echo $result['ad_content'];?>
                                                </script>
                                                <!-- 配置文件 -->
