                                ...
                                <div class="margin">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>IP地址</strong></span>
                                            <input type="text" class="form-control" value="<?php echo $result['ip'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>登陆时间</strong></span>
                                            <input type="text" class="form-control" value="<?php echo $result['login_time'];?>">
                                        </div>
