...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <form method="post" action="<?php echo $base_url;?>bluescms/index.php/menu/menu_add_post/">
                        <div class="box">
                            <div class="box-body">
                                <div class="margin">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="menu_first_id">
                                                <option value="0">新的一级栏目</option>
                                                <?php foreach ($result as $key => $first): ?>
                                                    <option value="<?php echo $first['menu_id'];?>"><?php echo $first['menu_name']?></option>
                                                    <?php foreach ($first['menu_second'] as $key2 => $second): ?>
                                                        <option disabled="disabled" value="<?php echo $second['menu_id'];?>"><?php echo $second['menu_name'];?></option>
                                                    <?php endforeach;?>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
