...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<ul>
    <p style = "width:150px; height:20px; overflow:hidden; display:inline-block;">管理员</p>
    <p style = "width:150px; height:20px; overflow:hidden; display:inline-block;">角色</p>
    <p style = "width:150px; height:20px; overflow:hidden; display:inline-block;">操作记录</p>
    <p style = "width:150px; height:20px; overflow:hidden; display:inline-block;">执行时间</p>
    </br>
			<?php if ($result): ?>
				<?php foreach ($result as $key => $value): ?>
					<p style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['user_name']?></p>
          <p style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['role_name']?></p>
          <p style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['behavior']?></p>
          <p style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['operate_time']?></p>
          <p style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['ip_address']?></p>
					<br />
				<?php endforeach;?>
			<?php else: ?>
				<li>没有任何日志记录</li>
