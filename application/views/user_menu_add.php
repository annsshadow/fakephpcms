...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <form method="post" action="<?php echo $base_url;?>bluescms/index.php/user_menu/menu_add_post/">
                        <div class="box">
                            <div class="box-body">
                                <div class="margin">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>栏目名称</strong></span>
                                            <input type="text" class="form-control" name="menu_name" placeholder="栏目名称(6字以内)">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>栏目排序</strong></span>
                                            <input type="number" class="form-control" name="menu_order" value="0" placeholder="栏目序号">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>所属一级栏目</strong></span>
                                            <select name="menu_first_id">
                                                <option value="0">新的一级栏目</option>
                                                <?php foreach ($result as $key => $first): ?>
                                                    <option disabled="disabled" value="<?php echo $first['user_menu_id'];?>"><?php echo $first['menu_name']?></option>
                                                    <?php foreach ($first['menu_second'] as $key2 => $second): ?>
                                                        <option disabled="disabled" value="<?php echo $second['user_menu_id'];?>"><?php echo $second['menu_name'];?></option>
                                                    <?php endforeach;?>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
