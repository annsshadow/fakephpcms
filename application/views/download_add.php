...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <form method="post" action="<?php echo $base_url;?>bluescms/index.php/download/download_add_post/">
                        <div class="box">
                            <div class="box-body">
                                <div class="margin">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>文件名</strong></span>
                                            <input type="text" name="headline" class="form-control" placeholder="文件名(不包含后缀)">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>上传者</strong></span>
                                            <input type="password" name="author" class="form-control" value="计算机科学与技术学院">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        <span class="input-group-addon">请使用"上传附件"功能上传</span>
                                    </div>
                                    <div class="input-group pull-right">
<!--                                        <input id="submitBtn" type="submit" name="submit" value="上传" class="btn btn-primary"></input>-->
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
