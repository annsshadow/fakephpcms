                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-header margin margin-bottom-none">
                            <a href="<?php echo $base_url . 'bluescms/index.php/ad/ad_add/';?>" class="btn btn-sm btn-default">添加广告项目</a>
                        </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <?php if(is_array($result)):?>
                                    <?php foreach($result as $key => $value):?>
                                        <tr>
                                            <td><a href="<?php echo $value['ad_url'];?>"><?php echo $value['ad_headline']?></a></td>
                                            <td><a href="<?php echo $value['ad_url'];?>"><?php echo $value['ad_url'];?></a></td>
                                            <td>
