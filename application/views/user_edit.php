...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <form method="post" action="<?php echo $base_url;?>bluescms/index.php/user/user_edit_post/">
                                ...
                                <div class="margin">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="user_name" class="form-control" value="<?php echo $result['user_name'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
