...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <form method="post" action="<?php echo $base_url;?>bluescms/index.php/user/user_add_post/">
                        <div class="box">
                            <div class="box-body">
                                <div class="margin">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>管理员登录名</strong></span>
                                            <input type="text" name="user_name" class="form-control" placeholder="管理员用户名">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>管理员密码</strong></span>
                                            <input type="password" name="password" class="form-control" placeholder="管理员密码">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><strong>管理员角色</strong></span>
                                            <select class="form-control" name="role_id">
<!--                                                <option>选择角色</option>-->
                                                <?php foreach ($role_level as $key => $value): ?>
                                                    <option value="<?php echo $value['role_id']?>"><?php echo $value['role_info']?></option>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
                                    </div>
