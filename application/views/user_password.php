  ...
  <div id="wrapper">
	...
	<div>
		<form id="form" method="post" action="<?php echo $base_url;?>bluescms/index.php/user/password_change_post/" onsubmit = "return check_password()">
			<li>当前登录的用户：<?php echo $login_info['login_user_name']?></li>
			<br />
			输入密码：<input type="password" name="password" id="password">
			<br />
			确认密码：<input type="password" name="second_password" id="second_password">
			<br />
