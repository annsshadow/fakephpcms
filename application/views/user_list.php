                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-header margin margin-bottom-none">
                            <a href="<?php echo $base_url;?>bluescms/index.php/user/user_add/" class="btn btn-sm btn-default">添加管理员</a>
                            <div class="col-sm-8 pull-right form-group margin-bottom-none">
                                <form action="#" method="get">
                                    <h5 class="col-md-4 text-center">搜索管理员:</h5>
                                    <div class="col-md-8">
                        ...
                        <div class="box-body table-responsive table-striped">
                            <table class="table table-hover">
                                ...
                                <?php if (is_array($result)): ?>
                                    ...
                                    <tr>
                                        <td><a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href = "<?php echo $first['url_view'];?>"> <?php echo $first['user_name'];?> </a></td>
                                        <td><?php echo substr($first['creattime'],0,10);?></td>
                                        <td><?php echo $first['role_name'];?></td>
                                        <td>
