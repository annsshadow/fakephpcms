...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<p>当前位置：编辑<?php echo $kind;?></p>
	</div>
    <div>
		<form method="post" action="<?php echo $base_url . 'bluescms/index.php/team_depart/team_depart_edit_post/' . $kind;?>">
			<input type="hidden" name="id" value="<?php echo $result['id']?>"/>
			名称:<input type="text" name="tdname" value="<?php echo $result['tdname']?>"/>
			<br />
