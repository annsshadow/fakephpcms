...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<p>当前位置：<?php echo $kind;?>管理列表</p>
	</div>
	<div>
		<a href="<?php echo $base_url . 'bluescms/index.php/team_depart/team_depart_add/' . $kind;?>">添加<?php echo $kind;?>项目</a>
	</div>
	<br />
	<div>
		<ul>
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">名称</span>
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">操作</span>
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">操作</span>
    <br />
			<?php if ($result): ?>
				<?php foreach ($result as $key => $value): ?>
					<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['tdname']?></a>
