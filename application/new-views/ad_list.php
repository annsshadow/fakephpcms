...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<a href="<?php echo $base_url . 'bluescms/index.php/ad/ad_add/';?>">添加广告项目</a>
	</div>
	<br />
	<div>
		<ul>
    ...
    <br />
			<?php if ($result): ?>
				<?php foreach ($result as $key => $value): ?>
					<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href="<?php echo $value['ad_url'];?>"><?php echo $value['ad_headline']?></a>
