                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-header margin margin-bottom-none">
                            <a href="<?php echo $base_url; ?>bluescms/index.php/role/role_add" class="btn btn-sm btn-default">添加角色</a>
                            <div class="col-sm-8 pull-right form-group margin-bottom-none">
                                <form action="#" method="get">
                                    <h5 class="col-md-4 text-center">搜索角色:</h5>
                                    <div class="col-md-8">
                        ...
                        <div class="box-body table-responsive table-striped">
                            <table class="table table-hover">
                                <thead>
                                <tr>
                                    <th width="253px">角色名</th>
                                    <th width="453px">角色描述</th>
                                    <th width="648px">right</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value['role_info']; ?></td>
                                    <td><?php echo $value['role_right']; ?></td>
                                    <td>
