...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<p>当前位置：添加<?php echo $kind;?>项目</p>
	</div>
    <div>
		<form method="post" action="<?php echo $base_url . 'bluescms/index.php/team_depart/team_depart_add_post/' . $kind;?>">
			名称:<input type="text"name="tdname"/>
			<br />
