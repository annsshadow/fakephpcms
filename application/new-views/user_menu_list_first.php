...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<a href="<?php echo $base_url;?>bluescms/index.php/user_menu/menu_add/">添加栏目</a>
		<br />
		<br />
	</div>
	<div>
		...
		<?php foreach ($result as $key => $value): ?>
			...
			<!--<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href="<?php echo $value['url_second'];?>">进入子栏目</a>-->
