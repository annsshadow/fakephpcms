...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<a href="<?php echo $base_url;?>bluescms/index.php/tag/tag_add/">添加标签</a>
		<br />
		<br />
	</div>
	<div>
		<ul>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">所属栏目</span>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">标签名称</span>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">更新人员</span>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">更新时间</span>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">操作</span>

      <br />
		<?php foreach ($result as $key => $value): ?>
			<span style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['menu_name'];?></span>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['tag_name'];?></span>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['updater'];?></span>
      <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;"><?php echo $value['updatetime'];?></span>
			<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href="<?php echo $value['url_edit'];?>">编辑</a>
			<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href="<?php echo $value['url_delete'];?>">删除</a>
			<br />
		<?php endforeach;?>
		</ul>
	</div>
