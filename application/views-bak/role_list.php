...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<a href="<?php echo $base_url;?>bluescms/index.php/role/role_add/">添加角色</a>
	</div>

	<div id = "list">
		<ul>
    <br />
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">角色名称</span>
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">操作</span>
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">操作</span>
    <br />
		<?php if (is_array($result)): ?>
			<?php foreach ($result as $key1 => $first): ?>
					<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href = "<?php echo $first['url_view'];?>"> <?php echo $first['role_name'];?> </a>
