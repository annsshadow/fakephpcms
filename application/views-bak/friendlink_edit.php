...
<body>
  ...
  <div id="wrapper">
    ...
    <div>
		<form method="post" action="<?php echo $base_url;?>bluescms/friendlink/friendlink_edit_post/">
			<input type="hidden" name="friendlink_id" value="<?php echo $result['friendlink_id']?>"/>
			headline:<input type="text"name="headline" value="<?php echo $result['headline']?>"/>
			<br />
			url:<input type="text"name="url" value="<?php echo $result['url']?>"/>
			<br />
