...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<ul>
			<li>role_name:<?php echo $result['name_info']['role_name'];?></li>
			<li>role_info:<?php echo $result['name_info']['role_info'];?></li>
			<ul>
			right:
			<?php foreach ($result['right_id_name'] as $key => $value): ?>
				<li><?php echo $value['right_name'];?></li>
			<?php endforeach;?>
			</ul>
		</ul>
	</div>
