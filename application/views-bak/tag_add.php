...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<form method="post" action="<?php echo $base_url;?>bluescms/index.php/tag/tag_add_post/">
			标签名称：<input type="text" name="tag_name" value=""/>
			<br />
			所属栏目:
        <select name="menu_id">
      ...
      <br />
      排序(默认是0，可不修改):<input type="text" name="ordernum" value="0"/>
      <br />
