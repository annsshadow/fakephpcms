...
<body>
  ...
  <div id="wrapper">
	...
	<div>
		<a href="<?php echo $base_url;?>bluescms/index.php/user/user_add/">添加管理员</a>
	</div>

	<div id = "list">
		<ul>
    <br />
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">管理员名称</span>
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">操作</span>
    <span style = "width:150px; height:20px; overflow:hidden; display:inline-block;">操作</span>
    <br />
		<?php if (is_array($result)): ?>
			<?php foreach ($result as $key1 => $first): ?>
					<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href = "<?php echo $first['url_view'];?>"> <?php echo $first['user_name'];?> </a>
					<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href = "<?php echo $first['url_edit'];?>">编辑</a>
					<a style = "width:150px; height:20px; overflow:hidden; display:inline-block;" href = "<?php echo $first['url_delete'];?>">删除</a>
					<br />
			<?php endforeach;?>
		<?php else: ?>
			<li>返回值不是数组，错误</li>
